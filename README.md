# HostsFileManager
HostsFileManager in C++<br>
<br>
Just an idee...<br>
...to rewrite the https://github.com/LV-Crew/HostsManager in C++.<br>
Just to keep the original idea up!<br>
<br>
=======================================================================<br>
<br>
...
- Monitor port-forwards (UPnP) from routers (AVM)<br>
